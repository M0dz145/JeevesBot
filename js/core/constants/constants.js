...
export const SPEAK = {
    // Complément circonstanciel ($1: Place, $2: Way, $3: Time)
    CIRCUMSTANTIAL_COMPLEMENT: {
        ...
        REGEXP: /\b(?:(?:au?|chez)\s((?:(?:l[ea]|une?)\s)?[A-zÀ-ÿ]+)|(?:en|sur(?:\s(?:l[ea]|une?))?)\s([A-zÀ-ÿ]+)|((?:lun|m[ae]r(?:cre)?|jeu|vendre|same)di|dimanche|heures?|minutes?|secondes?|jours?|semaines?|(?:après\s)?demain))(?!\w+)/gi
    },
